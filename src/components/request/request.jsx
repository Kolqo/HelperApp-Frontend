...
import LikeSVG from "../../assets/requestElementSVG/likeSVG/likeSVG";
    ...
    <>
      {props.responseData.map((item) => (
        <div key={item.id} className={styles.requestBox}>
          <div
            className={styles.requestBoxImage}
            onClick={() => {
              props.onClick();
          ...
          <div className={styles.requestBoxDescritionAndIcons}>
            ...
            <div className={styles.requestIcons}>
              ...
              >
                {item.selected ? (
                  <LikeSVG fill="black" height="20" weight="20" />
                ) : (
                  <LikeSVG fill="none" height="18" weight="20" />
                )}
              </div>
...
// {ifClick ? <LikeSVG fill="none" height="18" weight="18"/>:<LikeSVG fill="black" height="20" weight="20"/>}
